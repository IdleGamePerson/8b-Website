const WORDS = [
  ...
  { id: "vi", word: "vi", pos: "Fragewort",
    ...
    example: {
      ...
      { label: "Positiv", cells: ["vi"] },
      { label: "Komparativ", cells: ["vii"] },
      { label: "Superlativ", cells: ["viu"] },
  ]}},
  ...
  { id: "lebi", word: "lebi", pos: "Adjektiv",
    de: ['mehr'],
    ...
    example: {
      ...
      { label: "Positiv", cells: ["lebi"] },
      { label: "Komparativ", cells: ["lebii"] },
      { label: "Superlativ", cells: ["lebiu"] },
  ]}},
  { id: "oli", word: "oli", pos: "Adjektiv",
    de: ['nur'],
    ...
    example: {
      ...
      { label: "Positiv", cells: ["oli"] },
      { label: "Komparativ", cells: ["olii"] },
      { label: "Superlativ", cells: ["oliu"] },
  ]}},
  { id: "fino", word: "fino", pos: "Präposition",
    de: ['bis'],
  ...
  { id: "mi", word: "mi", pos: "Pronomen",
    ...
    example: {
      ...
      { label: "Nominativ", cells: ["mi"] },
      { label: "Akkusativ", cells: ["mie"] },
      { label: "Genitiv", cells: ["mia"] },
      { label: "Dativ", cells: ["mio"] },
  ]}},
  ...
  { id: "i", word: "i", pos: "Pronomen",
    ...
    example: {
      ...
      { label: "Nominativ", cells: ["i"] },
      { label: "Akkusativ", cells: ["ie"] },
      { label: "Genitiv", cells: ["ia"] },
      { label: "Dativ", cells: ["io"] },
  ]}},
];
